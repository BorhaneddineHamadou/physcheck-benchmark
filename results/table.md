...
|---|---|---|---|---|---|---|---|
| corner_case_ndd | 25 | 0 | 100.0% | 1 files | 154 | 154 | 100.0% |
| dlr_ht | 1 | 0 | 100.0% | 0 | — | — | — |
...
*physcheck 0.3.0; protocol, corpora provenance and per-finding triage: see the [benchmark repo](https://github.com/BorhaneddineHamadou/physcheck-benchmark).*
